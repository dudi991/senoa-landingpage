...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'waitlist.success': 'Fast geschafft. Bitte bestätige deine Anmeldung über den Link in deiner E-Mail.',
  ...
  en: {
    ...
    'waitlist.success': 'Almost there. Please confirm your subscription via the link in your email.',
